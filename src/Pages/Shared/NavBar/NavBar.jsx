    ...
    <>
      <li>
        <img
          ...
          className="w-12 h-12 rounded-full md:mr-6 cursor-pointer"
          alt=""
        />
      </li>
      <li>
    ...
    <div className="navbar bg-base-100 md:px-20">
      <div className="navbar-start">
        <div className="grid grid-cols-2 md:grid-cols-1">
          ...
          <Link className="flex items-center ml-16 md:ml-0 gap-2" to="/">
      ...
      <div className="navbar-end hidden lg:flex">
        {user ? (
          <ul className="navbar-end lg:flex">{loggedUser}</ul>
        ) : (
          <ul className="navbar-end lg:flex">{logUser}</ul>
        )}
      </div>
    </div>
  );
